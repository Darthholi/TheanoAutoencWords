# -*- coding: utf-8 -*-
"""
Created on Mon May 11 18:11:10 2015
...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_layer, numpy_rng=None, activation=None, batch_size=1): #activation is there just to make sure we can call it as a function in creating in another file. Maybe can be made to make sense...
    ...
    def getFinetuneCost(self,realy):                      #this layer can be output layer - must implement this method
        return self.negative_log_likelihood(realy)
    ...
    def negative_log_likelihood(self, y):
        ...
        return -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y])    #########################edit 
        # end-snippet-2
    ...
    def errors(self, y):
        ...
        if y.dtype.startswith('int'):
            ...
            #return T.mean(T.neq(self.y_pred, T.cast(T.round(y),'int32')))            #########################edit
            raise NotImplementedError()

def sgd_optimization_mnist(learning_rate=0.13, n_epochs=1000, batch_size=239):
    """
    ...
    classifier = LogisticRegression(input=x, n_in=dataset.const_lineInSize, n_out=2)# 2 classes - yes and no. ... dataset.NumOutputDatas == 1 so dont use that
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches): 
            ...
            minibatch_avg_cost = train_model(dataset.getcurX(minibatch_index),dataset.getcurY(minibatch_index))
            #print minibatch_avg_cost        #debug
            # iteration number
